...
export interface Report { id: string; title: string; createdAt: string; content: Record<string, unknown>; ioc?: IOC | null; attackProfile?: AttackDNA | null }
